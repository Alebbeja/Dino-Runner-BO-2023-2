...
class Dinosaur:
    ...
    def __init__(self):
      ...
      self.run_img = {DEFAULT_TYPE: RUNNING, SHIELD_TYPE: RUNNING_SHIELD}
      self.duck_img = {DEFAULT_TYPE: DUCKING, SHIELD_TYPE: DUCKING_SHIELD}
      self.jump_img = {DEFAULT_TYPE: JUMPING, SHIELD_TYPE: JUMPING_SHIELD, HAMMER_TYPE:}
    ...
    def update(self, user_input):
      ...
      if    self.step_index >= 10:
            self.step_index = 0
      if self.shield:
          time_to_show = round(self.time_up_power_up - pygame.time.get_ticts())/ 1000, 2
          if time_to_show < 0: 
